...
/**
 * The Class JWTFilter filter each request to the application and verify if
 * authentication/authorization is required for the API.
 */
public class JWTFilter extends BasicHttpAuthenticationFilter {
  ...
  /** The Constant STR_BEARER_LENGTH. */
  public static final int STR_BEARER_LENGTH = 7;
  /*
   * (non-Javadoc)
   * 
   ...
   * (non-Javadoc)
   * 
   * @see org.apache.shiro.web.filter.authc.AuthenticatingFilter#executeLogin(javax
  ...
  protected boolean executeLogin(final ServletRequest request, final ServletResponse response) throws Exception {
    ...
    if (authorization != null && !authorization.isEmpty() && authorization.startsWith("Bearer")) {
      authorization = authorization.substring(authorization.indexOf("Bearer") + STR_BEARER_LENGTH, 
   ...
   * 
   * @see org.apache.shiro.web.filter.authc.BasicHttpAuthenticationFilter#
   * isAccessAllowed(javax.servlet.ServletRequest, javax.servlet.ServletResponse, java.lang.Object)
   */
  @Override
